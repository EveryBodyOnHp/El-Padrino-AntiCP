  ...
  local user =db:hget("usuarios", blocks[1])
    if user then
        if (msg.chat.username) then
            ...
            api.sendKeyboard(tonumber(user), "🔰 ¡Te han Mencionado! \n 👥 Grupo: "..msg.chat.title.." \n 🗃 Tipo de Grupo: "..msg.chat.type.." \n 👤 Usuario: "..msg.from.username.." \n 💬 Mensaje: http://t.me/"..msg.chat.username.."/"..msg.message_id, do_keyboard_publico, true)
--            local keyboard = do_keyboard_publico()
  --          api.sendKeyboard(tonumber(user),"🔰 ¡Te han Mencionado! \n 👥 Grupo: "..msg.chat.title.." \n 🗃 Tipo de Grupo: "..msg.chat.type.." \n 👤 Usuario: "..msg.from.username,keyboard, true)

          else

            api.sendKeyboard(tonumber(user), "🔰 ¡Te han Mencionado! \n 👥 Grupo: "..msg.chat.title.." \n 🗃 Tipo de Grupo: "..msg.chat.type.." \n 👤 Usuario: "..msg.from.username, do_keyboard_privado, true)
  --        local keyboard = do_keyboard_privado()
    --      api.sendKeyboard(tonumber(user),"🔰 ¡Te han Mencionado! \n 👥 Grupo: "..msg.chat.title.." \n 🗃 Tipo de Grupo: "..msg.chat.type.." \n 👤 Usuario: "..msg.from.username,inline, true)
