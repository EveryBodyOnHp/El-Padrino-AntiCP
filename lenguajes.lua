return {
    ...
    bonus = {
        ...
        credits = 'ℹ️ Este bot esta basado en código Lua si encuentras cualquier falla comunicamelo en mi [Telegram](http://telegram.me/HuterCR) o bien, en el grupo de soporte de [Equipo TPYA](http://telegram.me/TPYAoficial).',
        extra = {
			usage = 'Escribe despues de /extra algún titulo de comando que sea asociado al activar.\n*Por ejemplo*:\n/extra #baile vamos a bailar. El Padrino responderá _\'vamos a bailar.\'_ cuando alguien escriba #baile',
		...
		settings = "*Moderadores*: Configuraciones de grupos\n\n"
            ...
            private = '¡Hola *&&&1*!\n'
                   ..'Soy El Padrino el mero mero de Telegram, un _bot moderador_ para tus grupos.\n'
                   ..'\n*¿Como puedo ayudarte?*\n'
                   ...
                   ..'\nSi deseas usarlo, por favor consulta a mis dueños [HuterCR](http://telegram.me/HuterCR) ó a [Soporte](http://telegram.me/TPYA_oficial) para promoverte.\n'
                   ..'\n_Por favor, regalános tu puntuación_ [aquí](https://telegram.me/storebot?start=) o *Ingresa* a [Foro Telegram](https://telegramforo.com)',
        ...
        report = {
            no_input = 'Enviame tus comentarios a mi [Telegram](http://telegram.me/HuterCR)',
	...
	banhammer = {
            ...
            general_motivation = 'No puedo expulsar a este usuario.\nProbablemente no soy administrador ó el usuario es moderador en el bot.'
        },
        floodmanager = {
